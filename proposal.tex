...
In Section~\ref{sec:experiments} we describe steps we took and propose future work. 
...
Second, we plan to design and optimize action selection process of dialogue system which not only increase user satisfaction, but also to learn new facts and thus perform more informed decisions.
