...
\todo{More rigorous section 2,3}
\todo{fixed missing citations}
...
Furthermore, multiple weak reward functions can be combined to form much stronger feedback signal~\cite{todo}.
