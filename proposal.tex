...
\OP{current trends in optimizing the agent without necessity to prepare complex reward functions:
\begin{itemize}
    \item Su
    \item adversarial neural networks and ALI
\end{itemize}
}
...
\OP{todo
\begin{itemize}
    \item discuss chatbots 
    \item no conditioning
    \item latent extraction of topic of utterances
    \item crucial conditioning on external resources - KB
\end{itemize}
}
