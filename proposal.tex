...
In Section~\ref{sub:data_annotation} we introduce reinforcement learning (RL) as tool of our choice for optimizing the evaluation/reward/loss function e.g. user satisfaction or mimicking the whole dialogue
...
The IRL is ill-posed problem in general~\cite{choi_inverse_2011} and is guaranteed to work only for special cases e.g.~\cite{abbeel_apprenticeship_2004}.  \todo{Understand~\cite{choi_inverse_2011} better}
