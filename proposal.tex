...
\todo{describe problems and how to solve them}
\todo{how to simplify the model - templates}
\todo{todo what model we tried and conclude that we did not have enough data, model too complicated}
